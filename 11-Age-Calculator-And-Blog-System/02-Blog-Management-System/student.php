...
session_management(3); // Student role validation

$user_name = $_SESSION['users']['first_name']." ".$_SESSION['users']['last_name'];

// Check agar student ne kisi specific post ke "Read More" par click kiya hai
...
<head>
	...
	<style>
		...
		.logout-link {
			...
			right: 0;
			top: 0;
			color: #800080; /* Purple logout link */
			font-weight: bold;
		...
		/* Screenshot Matching Style */
		.post-container {
			background-color: #add8e6; /* Light blue box background */
		...
		?>
			<div class="post-container">
				...
				<div class="view-all-container">
					<a href="student.php" class="view-all-posts-btn">View All Posts</a>
				</div>
			</div>
		<?php 
		} else {
