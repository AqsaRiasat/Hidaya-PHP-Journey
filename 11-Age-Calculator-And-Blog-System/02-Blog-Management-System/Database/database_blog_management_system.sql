CREATE DATABASE IF NOT EXISTS `log_management_system` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
(3, 'Hello', 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.', 1, '1780472777'),
